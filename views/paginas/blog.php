        ...
        <article class="entrada-blog">
            ...
            <div class="texto-entrada">
                <a href="/entrada">
                    ...
                    <p>Escrito el <span>01/02/2025</span> por: <span>Admin</span></p>
        ...
        <article class="entrada-blog">
            <div class="imagen">
                <picture>
                    ...
                    <image loading="lazy" src="build/img/blog3.jpg" alt="Texto entrada blog">
                </picture>
            </div>
            <div class="texto-entrada">
                <a href="/entrada">
        ...
        <article class="entrada-blog">
            <div class="imagen">
                <picture>
                    ...
                    <image loading="lazy" src="build/img/blog4.jpg" alt="Texto entrada blog">
                </picture>
            </div>
            <div class="texto-entrada">
                <a href="/entrada">
